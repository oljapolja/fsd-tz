$(function() {
   ...
   $(".search-room-filter-section__side-bar_right .filter-button").click(function() {
      $(".search-room-filter-section__side-bar_right").toggleClass('on');
      $(".search-room-filter-section__side-bar_left").toggleClass('on');
   });
...
// //  });
   ...
   // $(".room-bill-form").clone().appendTo(".room-details-section__qualities-area");
